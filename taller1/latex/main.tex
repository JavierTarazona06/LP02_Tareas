...
\begin{itemize}
  ...
  \item \textbf{Línea 5 — Unicode fuera del patrón:} El símbolo \texttt{$\pi$} (pi) está fuera del alfabeto ASCII básico usado en la expresión regular de identificadores. Aunque Python internamente puede manejar Unicode, la gramática definida en este lexer lo excluye. Se reporta como un carácter inválido.
\end{itemize}
